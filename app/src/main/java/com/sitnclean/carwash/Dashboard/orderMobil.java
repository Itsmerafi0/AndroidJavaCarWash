...
public class orderMobil {

    String id, email, nama, hp,date,time, ourservice, ourservice1, ourservice2, address, plat, othinformation, total, status;

    public orderMobil (String id,String nama, String email, String hp,String date,String time,String ourservice, String ourservice1, String ourservice2 ,String address, String plat, String othinformation,String total, String status) {
        this.id = id;
        this.nama = nama;
        this.hp = hp;
        this.date = date;
