...
import com.sitnclean.carwash.databinding.ActivityMobilBinding;

import java.util.ArrayList;
import java.util.Calendar;

public class Mobil extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.ourservice.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                arrayAdapter_harga = new ArrayAdapter<>(Mobil.this, R.layout.style_harga, arrayList_ourservice_basic);
        ...
        binding.ourservice1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                arrayAdapter_harga1 = new ArrayAdapter<>(Mobil.this, R.layout.style_harga, arrayList_ourservice_premium);
        ...
        binding.ourservice2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                arrayAdapter_harga2 = new ArrayAdapter<>(Mobil.this, R.layout.style_harga, arrayList_ourservice_hyper);
    ...
    void pesanan() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        MobilBasic hargamobil = snapshot.getValue(MobilBasic.class);

                        arrayList_ourservice.add(hargamobil.getNama());
                        arrayList_harga.add(hargamobil.getHarga().toString());

                    }

                    arrayAdapter_ourservice = new ArrayAdapter<>(Mobil.this, R.layout.style_ourservice, arrayList_ourservice);
        ...
        Query query = FirebaseDatabase.getInstance().getReference("Basicmobil");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        arrayList_ourservice1.add(hargamobil.getNama());
                        arrayList_harga1.add(hargamobil.getHarga().toString());
                    }

                    arrayAdapter_ourservice1 = new ArrayAdapter<>(Mobil.this, R.layout.style_ourservice, arrayList_ourservice1);
        ...
        Query query1 = FirebaseDatabase.getInstance().getReference("Basicmobil");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        arrayList_ourservice2.add(hargamobil.getNama());
                        arrayList_harga2.add(hargamobil.getHarga().toString());
                    }

                    arrayAdapter_ourservice2 = new ArrayAdapter<>(Mobil.this, R.layout.style_ourservice, arrayList_ourservice2);
        ...
        Query query2 = FirebaseDatabase.getInstance().getReference("Basicmobil");
    ...
    void set_selection() {
        ...
        binding.ordermobil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...

                {
                    ...
                    databaseMobil = FirebaseDatabase.getInstance().getReference("OrderMobil");
                    String id = databaseMobil.push().getKey();

                    orderMobil ordermobil = new orderMobil(id, nama, email, hp, date, time, ourservice, ourservice1,ourservice2,  address, plat, othinformation, total, status);

                    databaseMobil.child(id).setValue(ordermobil).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            Toast.makeText(Mobil.this, "Order Berhasil!", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(Mobil.this, Thanks.class));
