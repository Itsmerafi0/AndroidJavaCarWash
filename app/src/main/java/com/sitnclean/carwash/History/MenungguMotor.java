...
public class MenungguMotor extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.proses:
                ...
                break;
            case R.id.selesai:
                startActivity(new Intent(this, SelesaiMotor.class));
                break;
            case R.id.semua:
