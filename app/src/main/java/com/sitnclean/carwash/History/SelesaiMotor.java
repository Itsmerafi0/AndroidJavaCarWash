...
public class SelesaiMotor extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance().getReference("OrderMotor");
        ...
        Query query = FirebaseDatabase.getInstance().getReference("OrderMotor")
                .orderByChild("status")
                .equalTo("Selesai");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.menunggu:
                startActivity(new Intent(this, MenungguMotor.class));
                break;
            case R.id.proses:
                startActivity(new Intent(this, ProsesMotor.class));
                break;
            case R.id.semua:
